...
class Verification:
    # staticmethod is used for functions who don't need to access any other
    # attribute or method in the same class
    ...
    # classmethod is used for funtions who don't need access to any attributes
    # in the class
    ...
    def verify_transaction(transaction, get_balance, check_funds=True):
        if check_funds:
            ...
            return (balance_sender >= transaction.amount and
                    Wallet.verify_transaction_signature(transaction))
        else:
